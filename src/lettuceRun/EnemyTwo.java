...
public class EnemyTwo {
    ...
    boolean[][] eblocked = BlockedTwo.getblocked();
    ...
    EnemyTwo(int a, int b) throws SlickException {
    ...
    private boolean canigoup() {
        ...
        fdelta = LettuceWorld.player.getpdelta();
    ...
    void setdirection() {
        ...
        if (LettuceWorld.player.getplayersY() < this.By) {
        ...
        if ((LettuceWorld.player.getplayersX() > this.Bx)) {

            this.mydirection = Direction.RIGHT;

        }

        if ((LettuceWorld.player.getplayersX() < this.Bx) && canigoleft()) {
    ...
    void move() throws SlickException {
        ...
        if (this.Bx > LettuceWorld.player.getplayersX()) {

            this.moveleft();

        } else if (this.Bx < LettuceWorld.player.getplayersX()) {
        ...
        if (this.By > LettuceWorld.player.getplayersY()) {

            this.moveup();

        } else if (this.By < LettuceWorld.player.getplayersY()) {
